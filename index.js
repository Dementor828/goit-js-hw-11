import{a as d,S as p,i}from"./assets/vendor-C8Aay8I4.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const o of t)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function a(t){const o={};return t.integrity&&(o.integrity=t.integrity),t.referrerPolicy&&(o.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?o.credentials="include":t.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(t){if(t.ep)return;t.ep=!0;const o=a(t);fetch(t.href,o)}})();const f="55197171-7badb4f38387852aef8c7c06b",h=d.create({baseURL:"https://pixabay.com/api"});function m(e){const r={key:f,q:e,image_type:"photo",orientation:"horizontal",safesearch:!0};return h.get("/",{params:r}).then(a=>a.data)}const l={form:document.querySelector(".form"),gallery:document.querySelector(".gallery"),loader:document.querySelector(".loader")};let s=null;function y(){s||(s=new p(".gallery a",{captionsData:"alt",captionDelay:250})),s.refresh()}function g(e){l.gallery.innerHTML=_(e),y()}function _(e){return e.map(r=>L(r)).join("")}function L(e){return`
